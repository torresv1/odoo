...
function pos_adv_discount_model(instance,module) {
    ...
    module.PosModel.prototype.models.push({
            ...
            fields: ['name','code', 'amount','value_method', 'partner','product','pcategory', 'cfilter','pfilter','special_rule','product_1','pro_val_1','product_2','pro_val_2', 'start_date', 'end_date', 'journal_id'],
